...
function BookAppointment() {
    ...
    const [paymentMethod, setPaymentMethod] = useState('clinic'); // Changed from 'pay_at_clinic' to 'clinic'
    ...
    const handlePaymentFailure = () => {
        ...
        Swal.fire({
            ...
            text: 'You can try again from your appointments page.',
            icon: 'error',
        ...
        try {
            ...
            if (response.data.success) {
                ...
                if (paymentMethod === 'razorpay') {
                    // Instead of showing a Swal dialog first, directly set the flag to show Razorpay interface
                    setShowPaymentSection(true);
                    setBookedAppointmentId(appointmentId);
                    
                    // Find the Razorpay button and click it programmatically
                    setTimeout(() => {
                    ...
                    // Regular flow for pay at clinic
                    Swal.fire({
            ...
            content: (
                <div className="confirmation">
                    <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg shadow">
                                    ...
                                    <div className="mt-4 border-t pt-4">
                                        ...
                                        >
                                            <div className="flex flex-col space-y-3">
                                                <Radio.Button 
                                                    value="clinic" 
                                                    className="flex items-center justify-between p-3 h-auto border rounded-lg hover:border-blue-500 transition-colors"
                                                    style={{ 
                                                        width: '100%', 
                                                        textAlign: 'left',
                                                ...
                                                >
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="text-xs text-gray-500">Pay the consultation fee directly at the clinic</div>
                                                        </div>
                                                    </div>
                                                </Radio.Button>
                                                ...
                                                <Radio.Button 
                                                    ...
                                                    style={{ 
                                                        width: '100%', 
                                                        textAlign: 'left',
                                                        backgroundColor: paymentMethod === 'razorpay' ? '#f0f7ff' : 'white',
                                                        borderColor: paymentMethod === 'razorpay' ? '#1890ff' : '#d9d9d9'
                                                    }}
                                                >
                                                    <div className="flex items-center">
                                                        <div className="mr-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="text-xs text-gray-500">Secure payment via Razorpay (Credit/Debit Card, UPI, etc.)</div>
                                                        </div>
                                                    </div>
                                                </Radio.Button>
                                            </div>
                        ...
                        {showPaymentSection && bookedAppointmentId && (
                            <div className="bg-blue-50 p-4 rounded-lg mt-6">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <span className="text-lg font-bold text-blue-700">₹{doctor?.feePerConsultation || 'Consultation fee'}</span>
                                </div>
                                ...
                                <div className="flex justify-center my-4">
                                    <RazorpayCheckout 
                                        ...
                                        amount={doctor?.feePerConsultation || 500}
                                        doctorName={`Dr. ${doctor?.firstname || 'Unknown'} ${doctor?.lastname || ''}`}
                ...
                <div className='p-3 sm:p-4 max-w-6xl mx-auto'>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="steps-action mt-8 flex justify-between">
                            ...
                            {currentStep === steps.length - 1 && !showPaymentSection && (
                                <Button
                                    type="primary" 
